...
export const getDefaultGenresValues = () => [
  ...
  { selected: false, id: 4, name: i18n.t('genres_label_action') },
  { selected: false, id: 5, name: i18n.t('genres_label_drama') },
  { selected: false, id: 6, name: i18n.t('genres_label_giant_robots') },
]
