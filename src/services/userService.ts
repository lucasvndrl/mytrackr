...
export const registerUser = async ({
  ...
  const response = await axios.post(
    `https://459f-170-78-98-225.ngrok-free.app/account/`,
    {
      account,
    },
    {
...
export const getUserDetails = async (
  ...
  try {
    const response = await axios.get(`https://459f-170-78-98-225.ngrok-free.app/account/`, {
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
    })
...
export const deleteUser = async (accessToken: string): Promise<AxiosResponse> => {
  const response = await axios.delete(`https://459f-170-78-98-225.ngrok-free.app/account/`, {
    headers: {
      Authorization: `Bearer ${accessToken}`,
    },
  })
